...
int main() {
    ...
    auto window_test1 = test.template slice<3, 3>({ 0, 0 });
    ...
    auto window_test2 = test.template slice<3, 3>({ 1, 1 });
    ...
    auto window_test_3 = window_test1.template slice<2, 2>({ 1, 1 });
    ...
    auto window_test_4 = window_test1.template slice<2, 2>({ 0, 0 });
    ...
    auto window_test_5 = window_test1.template slice<2, 2>({ 0, 1 });
    ...
    auto window_reshape_test = window_test_5.template reshape<4>();
